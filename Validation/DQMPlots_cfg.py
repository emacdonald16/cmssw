...
if TrackReco == "Tracklet_Emulation":
    ...
    process.validation_OuterTracker = cms.Path(process.DQM_trkParticles)
    process.dqmoffline_OuterTracker = cms.Path(process.OuterTrackerMonitorTTCluster*process.OuterTrackerMonitorTTStub*process.DQM_tracks)
...
process.schedule = cms.Schedule(process.tracks, process.dqmoffline_OuterTracker, process.dqmsave_step)
